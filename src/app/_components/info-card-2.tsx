...
function InfoCard2({ inter }: { inter: NextFont }) {
  return (
    <div className='rounded-3xl overflow-clip h-[28rem] lg:h-[28rem] transition duration-1000 group card-gradient-2 lg:col-span-3'>
      <div className={'relative p-5 lg:p-8 flex flex-col justify-end transition duration-1000 h-full'}>
        ...
        <p className={inter.className + ' text-xs xl:text-sm mt-4 lg:mt-6'}>
          ...
          apps used by millions of users worldwide. <br /><br /> Alongside starting and growing businesses, Michael has advised and supported startups, investors and
